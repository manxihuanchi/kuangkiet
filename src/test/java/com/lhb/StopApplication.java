package com.lhb;
	...
	public class StopApplication {
		 private final static String accessKeyId = "xxxx";
		  private final static String accessKeySecret = "xxx";
	    ...
	    public static void main(String[] args_) throws Exception {
	        ...
	        com.aliyun.sae20190506.Client client = DescribeApplicationStatus.createClient(accessKeyId, accessKeySecret);
	           com.aliyun.sae20190506.models.StopApplicationRequest stopApplicationRequest = new com.aliyun.sae20190506.models.StopApplicationRequest()
	                .setAppId("c46d4292-b1df-4e30-93d6-a79393288b9c");
	        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
	        java.util.Map<String, String> headers = new java.util.HashMap<>();
	        try {
	            // 复制代码运行请自行打印 API 的返回值
	            client.stopApplicationWithOptions(stopApplicationRequest, headers, runtime);
