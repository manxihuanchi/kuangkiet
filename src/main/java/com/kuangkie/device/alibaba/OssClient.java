package com.kuangkie.device.alibaba;
...
public class OssClient {
		   ...
		   * 上传文件
		   */
		  public String uploading(String ossFileName, String filePath) {

	        try {
	            // 创建PutObjectRequest对象。
	            PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, ossFileName, new File(filePath));
		        ...
		        String url = " https://saeweb.oss-cn-hangzhou.aliyuncs.com/" + ossFileName;
	            return url;
